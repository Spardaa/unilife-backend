...
| :---- | :---- | :---- | :---- |
| **A1. Router** | 调度官 | GPT-3.5-Turbo / Haiku | 意图识别，分流请求。 |
| **A2. Executor** | 执行官 | GPT-4o / Sonnet (Tools) | **理性大脑**。处理日程逻辑、API调用、冲突检测。**无感情**。 |
| **A3. Persona** | 陪伴者 | GPT-4o-mini / Gemini Flash | **感性嘴巴**。负责拟人化回复、情感抚慰。不直接操作数据库。 |
| **A4. Observer** | 观察者 | GPT-4o / Opus | **潜意识/灵魂**。后台运行。分析日志，提取画像，生成决策规则。 |
